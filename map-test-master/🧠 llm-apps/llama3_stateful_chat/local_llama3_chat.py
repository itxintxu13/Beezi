...
st.title("ChatGPT Local con Memoria 🦙")
st.caption("Chatea con Llama-3 alojado localmente con memoria habilitada usando LM Studio 💯")
...
if prompt := st.chat_input("¿Qué pasa?"):
    st.session_state.messages.append({"role": "system", "content": "Cuando la entrada comience con /add, no continúes con un prompt."})
